...
#define OVERMAP_Z_LEVEL 3 // overmap z-level

// size of the overmap (OVERMAP_SIZE x OVERMAP_SIZE)
#define OVERMAP_SIZE 25 // keep this odd to provide a centre tile

// These overmap coords are configured to place it in the bottom left of the z level
#define OVERMAP_LEFT_SIDE_COORD 1
#define OVERMAP_RIGHT_SIDE_COORD (OVERMAP_LEFT_SIDE_COORD + (OVERMAP_SIZE - 1))

#define OVERMAP_SOUTH_SIDE_COORD 1
#define OVERMAP_NORTH_SIDE_COORD (OVERMAP_SOUTH_SIDE_COORD + (OVERMAP_SIZE - 1))
...
// Ship faction prefixes
#define NANOTRASEN_SHIP "NTV"
#define SYNDICATE_SHIP "SSV"
#define HOSTILE_SHIP "HSV"
#define NEUTRAL_SHIP "SV"
